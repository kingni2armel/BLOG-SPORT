...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name = "description" content="toute l'actualité du sport sur master class sport.... ">
        <meta name ="robots" content =" index,follow,sports,news">
...
?>
    ...
    <!-- ------------x---------------  Navigation --------------------------x------------------- -->
    <?php  include('vues/headerPageHome.php'); ?> 
    ...
    <main>
        ...
        <section class="site-title" style="margin-top:15px">
            <div class="site-background" data-aos="fade-up" data-aos-delay="100">
                <h1>Les Informations sur le sport</h1>
        ...
        $req=$bdd->query('SELECT description,datePublication,file_url FROM publication ORDER BY id_publication DESC ');
?>
                ...
                <div class="container">
                    ...
                    <?php
                         ...
                         <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            <img class="style-image" src="<?php echo 'vues/'.$resultat['file_url'];?>" alt="ddfdfggg" alt="post-1">
                            <div class="blog-title">
                                <h3><?php echo  $resultat['description']; ?></h3>
                                <button class="btn btn-blog">Fashion</button>
                                <span><?php echo $resultat['datePublication']?></span>
                            </div>
                        </div>
            ...
            <div class="site-content">
                ...
                <aside class="sidebar">
                    ...
                    <div class="newsletter" data-aos="fade-up" data-aos-delay="300">
                                            ...
                                            <?php
                                             include('vues/layout/newletter.php');
    ...
    <footer class="footer">
        <div class="container">
            <div class="about-us" data-aos="fade-right" data-aos-delay="200">
                ...
                <a href="vues/connexion.php">sing in</a>               
